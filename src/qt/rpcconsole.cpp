                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strnSBEPathCustom = GetArg("-nsbebackuppath", "");
    ...
    if(!strnSBEPathCustom.empty()) {
        ui->wallet_customnsbebackuppath->setText(QString::fromStdString(strnSBEPathCustom));
        ui->wallet_customnsbebackuppath_label->setVisible(true);
        ui->wallet_customnsbebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strnSBEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SOMBE RPC console.") + "<br>" +
