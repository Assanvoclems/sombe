...
public:
    ...
    void setNSbeControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintnSBE_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendnSBE_clicked();
    void on_pushButtonNSbeControl_clicked();
