...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SBE:
            return QString("tSBE");
        case mSBE:
            return QString("mtSBE");
        case uSBE:
            return QString::fromUtf8("μtSBE");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SBE:
            return QString("SBE");
        case mSBE:
            return QString("Milli-SBE (1 / 1" THIN_SP_UTF8 "000)");
        case uSBE:
            return QString("Micro-SBE (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SBE:
            return QString("TestSBEs");
        case mSBE:
            return QString("Milli-TestSBE (1 / 1" THIN_SP_UTF8 "000)");
        case uSBE:
            return QString("Micro-TestSBE (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
