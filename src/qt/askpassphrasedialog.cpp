                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_nSBE || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending SBE because you wouldn't check it anyway.
    if (context == Context::Send_SBE || context == Context::Send_nSBE) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR SBE</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("SOMBE will close now to finish the encryption process. "
                               ...
                               "your SBEs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
