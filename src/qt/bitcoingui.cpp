                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SOMBE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SOMBE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sombe: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for nSBE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SOMBE Core"), this);
    aboutAction->setStatusTip(tr("Show information about SOMBE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SOMBE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SOMBE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SOMBE addresses"));
    ...
    openAction->setStatusTip(tr("Open a SOMBE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SOMBE Core help message to get a list with possible SOMBE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SOMBE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SOMBE network", "", count));
}
...
{
    QString strTitle = tr("SOMBE Core"); // default title
