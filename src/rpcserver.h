...
extern UniValue setnsbeseed(const UniValue& params, bool fHelp);
extern UniValue getnsbeseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdnsbe(const UniValue& params, bool fHelp);
extern UniValue dnsbestate(const UniValue& params, bool fHelp);
