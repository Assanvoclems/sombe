...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_2_IBANTX) r = SPORK_2_IBANTX_DEFAULT;
        if (nSporkID == SPORK_3_IBANTX_BLOCK_FILTERING) r = SPORK_3_IBANTX_BLOCK_FILTERING_DEFAULT;
...
{
    if (strName == "SPORK_2_IBANTX") return SPORK_2_IBANTX;
    if (strName == "SPORK_3_IBANTX_BLOCK_FILTERING") return SPORK_3_IBANTX_BLOCK_FILTERING;
...
{
    if (id == SPORK_2_IBANTX) return "SPORK_2_IBANTX";
    if (id == SPORK_3_IBANTX_BLOCK_FILTERING) return "SPORK_3_IBANTX_BLOCK_FILTERING";
