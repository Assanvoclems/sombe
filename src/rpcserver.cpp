...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"sombe", "mnbudget", &mnbudget, true, true, false},
        ...
        {"sombe", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getnsbeseed", &getnsbeseed, false, false, true},
        {"zerocoin", "setnsbeseed", &setnsbeseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdnsbe", &searchdnsbe, false, false, true},
        {"zerocoin", "dnsbestate", &dnsbestate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23512/\n";
}
