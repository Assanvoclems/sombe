Contributing to SOMBE Core
============================

The SOMBE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SOMBE Core project, and is not to be
confused with overall SOMBE Network Protocol consensus changes.

Whether a pull request is merged into SOMBE Core rests with the project merge
...
Patches that change SOMBE consensus rules are considerably more involved than
...
Where a patch set proposes to change the SOMBE consensus, it must have been
...
The project leader is the release manager for each SOMBE Core release.
