...
#   c) node1 mines 32 blocks, so now node 0 has 60001sbe, node 1 has 4250sbe, node2 has none.
#   d) node0 sends 601 sbe to node2, in two transactions (301 sbe, then 300 sbe).
